...
const Resume_checker = () => {
  ...
  return (
    <div className='bg-gradient-to-br from-[#ff00cc] via-[#7a33cc] to-[#333399]'>
      <div className="overflow-x-hidden min-h-screen flex justify-center items-center text-white pt-2 px-6 md:px-12">
        <Toaster
          position="top-center"
          reverseOrder={true}
        />
      ...
      <div className="flex items-center justify-center pb-8">
        <button onClick={() => navigate(`/Payments/AI ChatBot`)} className="
      relative group px-9 py-3 rounded-2xl 
      font-semibold text-white tracking-wide
      bg-gradient-to-r from-fuchsia-500 via-purple-600 to-indigo-500
      shadow-[0_0_20px_rgba(190,0,255,0.5)]
      hover:shadow-[0_0_35px_rgba(190,0,255,0.7)]
      transition-all duration-300 ease-out
      hover:-translate-y-1 hover:scale-[1.07] active:scale-95
      overflow-hidden
  ">
    ...
    "
          ...
          {/* Glow Pulse */}
          <span className="
        absolute inset-0 bg-fuchsia-500/20 
